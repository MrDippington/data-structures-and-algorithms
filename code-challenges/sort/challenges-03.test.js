...
const alphabetizeBetter = (arr) => arr.sort(( a, b ) => b.toUpperCase() < a.toUpperCase() );
...
const sortPeople = (arr) => arr.sort(( a, b ) => b.lastName < a.lastName);
...
const sortPeopleBetter = (arr) => {
  return arr.sort( (a, b) => {
    if (a.lastName !== b.lastName) { //ternary operation
